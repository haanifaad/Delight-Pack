            ...
            <ul className="space-y-5">
              <li className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-sm">Ras Al Khor Industrial Area 2, Dubai, UAE</p>
                </div>
              </li>
              <li className="flex items-start gap-4">
                <div className="p-2.5 rounded-xl bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400">
              ...
              <li className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-sm">Quote within 1 business day</p>
                </div>
              </li>
            </ul>
          </div>
